...
void gpt2_forward(GPT2 *model, const int* inputs, size_t B, size_t T) {
    ...
    for (int l = 0; l < L; l++) {
        ...
        attention_forward(l_atty, l_qkvr, l_att, scratch, B, T, C, NH, nullptr, nullptr, main_stream);
        #endif
...
void gpt2_backward_and_reduce(GPT2 *model, int* inputs, const int* targets, int grad_accum_steps, int micro_step) {
    ...
    for (int l = L-1; l >= 0; l--) {
        ...
        attention_backward(dl_bt4c, buffer_b, scratchX, buffer_a, dl_btc, l_qkvr, l_att, B, T, C, NH, nullptr, nullptr, main_stream);
        #endif
        if(model->recompute >= 2) {
